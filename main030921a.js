...
function GetTradesBySymbol(sSymbolToLookup, sAccountID, sAccountName, sTRId, idxSymbol) {
    ...
    s = s + "<td style=\"width:18%; text-align:center;vertical-align:top;border-width:0px;\">&nbsp;</td>";
    ...
    s = s + "<th style=\"width:18%; text-align:center;vertical-align:top;border-width:0px;\"><I>Cost</I></th>";
